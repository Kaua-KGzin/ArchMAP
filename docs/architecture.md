...
There are two static copies of the UI assets:
- `web-ui/static/` for local Node-based development
- `src/archmap/web-ui/static/` for packaging into the Python distribution
...
Tests assert that these copies stay identical.
