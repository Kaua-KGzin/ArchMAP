...
def test_register_generic_parsers_populates_fresh_registry():
    fresh_registry = LanguageRegistry()

    register_generic_parsers(fresh_registry)

    assert fresh_registry.get_language_by_ext(".php") == "php"
    assert fresh_registry.get_language_by_ext(".java") == "java"
    assert fresh_registry.get_language_by_ext(".cs") == "csharp"
    assert fresh_registry.get_language_by_ext(".cpp") == "cpp"
